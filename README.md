...
3. For the Semantic AD tasks, please run the train_cifar10.py (cifar10, cifar100 and cat_vs_dog datasets) and occ_train_mnist.py (mnist and f-mnist datasets).
