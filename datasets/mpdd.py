...
MPDD_CLASS_NAMES_1 = ['bracket_black', 'bracket_brown']
MPDD_CLASS_NAMES_2 = ['bracket_white', 'tubes']
MPDD_CLASS_NAMES_3 = ['metal_plate', 'connector']
...
class MPDD_Dataset(Dataset):
    ...
    def __init__(self,
                 ...
                 wild_ver=False,
                 noise=0):
        assert class_name in MPDD_CLASS_NAMES, 'class_name: {}, should be in {}'.format(
            class_name, MPDD_CLASS_NAMES)
