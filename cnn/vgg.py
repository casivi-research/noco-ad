...
class VGG(nn.Module):
    ...
    def forward_coarse_grained(self, x: torch.Tensor) -> torch.Tensor:
        layers = [52]
        outputs = list() 
        for idx, l in enumerate(self.features):
            x = l(x)
...
cfgs: Dict[str, List[Union[str, int]]] = {"E": [64, 64, "M", 128, 128, "M", 256, 256, 256, 256, "M", 512, 512, 512, 512, "M", 512, 512, 512, 512, "M"]}
